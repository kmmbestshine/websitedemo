...
Route::group(
    ...
    // Account
    //Route::resource('acc/add', 'AccountController', ['as' => 'acc']);
    Route::get('acc/sector', 'AccountController@sectors')
        ->name('acc.add.sector');
    Route::post('acc/createsector', 'AccountController@storeSector')
        ->name('acc.add.storeSector');
    Route::get('acc/createexpense', 'AccountController@expense')
        ->name('acc.add.expense');
    Route::post('acc/storeExpense', 'AccountController@storeExpense')
        ->name('acc.add.storeExpense');
    Route::get('acc/expense-list', 'AccountController@listExpense')
        ->name('acc.view.expense-list');
    Route::post('acc/year/expense-list', 'AccountController@postExpense')
        ->name('acc.view.year.expense-list');
    Route::get('acc/createincome', 'AccountController@income')
        ->name('acc.add.income');
    Route::post('acc/storeIncome', 'AccountController@storeIncome')
        ->name('acc.add.storeIncome');
    Route::get('acc/income-list', 'AccountController@listIncome')
        ->name('acc.view.income-list');
    Route::post('acc/year/income-list', 'AccountController@postIncome')
        ->name('acc.view.year.income-list');
