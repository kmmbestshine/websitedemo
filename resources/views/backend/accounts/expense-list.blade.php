...
<!-- Page title -->
@section('pageTitle') Account Sectors @endsection
<!-- End block -->
            ...
            <div class="col-md-6">
              ...
              <div class="page-panel-title">@lang('View List of  Expense')
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{URL::route('acc.view.year.expense-list')}}" method="post">
                      {{ csrf_field() }}
            ...
            <div class="col-md-12">
              @isset($expenses)
                    <div class="table-responsive">
                      ...
                      <h2 style="text-align:center;">@lang('KMM SCHOOL')</h2>
  ...
  <style>
    ...
    var config = {
      ...
      options: {
        title: {
                    display: true,
          text: @json( __('Expense  in Time Scale'))
        },
