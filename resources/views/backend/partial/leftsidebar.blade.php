...
<aside class="main-sidebar">
    <section class="sidebar">
        ...
        @canany(['hrm.employee.index', 'hrm.leave.index', 'hrm.work_outside.index', 'hrm.policy'])
            ...
            <li class="treeview">
                <a href="#"><i class="fa fa-users"></i>
                    <span>Account</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    @can('hrm.employee.index')
                        <li>
                            <a href="{{ URL::route('acc.add.sector') }}">
                                <i class="fa icon-member"></i> <span>Add Account Sector</span>
                            </a>
                        </li>
                    @endcan
                    @can('hrm.leave.index')
                        <li>
                            <a href="{{ URL::route('acc.add.expense') }}">
                                <i class="fa fa-bed"></i> <span>Add New Expense</span>
                            </a>
                        </li>
                    @endcan
                    @can('hrm.leave.index')
                        <li>
                            <a href="{{ URL::route('acc.view.expense-list') }}">
                                <i class="fa fa-bed"></i> <span>Expense List</span>
                            </a>
                        </li>
                    @endcan
                    @can('hrm.leave.index')
                        <li>
                            <a href="{{ URL::route('acc.add.income') }}">
                                <i class="fa fa-bed"></i> <span>Add New Income</span>
                            </a>
                        </li>
                    @endcan
                    @can('hrm.leave.index')
                        <li>
                            <a href="{{ URL::route('acc.view.income-list') }}">
                                <i class="fa fa-bed"></i> <span>Income List</span>
                            </a>
                        </li>
                    @endcan
